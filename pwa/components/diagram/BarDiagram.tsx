...
const BarComponent = () => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            const res = await fetch('/number_sales_by_date/' + type + '/' + dateStart + '/' + dateEnd);
...
class SVG {
    static data: { label: string, value: number }[];
    static svg: d3.Selection<SVGSVGElement, unknown, HTMLElement, any>;
    static x: d3.ScaleBand<string>;
    static y: d3.ScaleLinear<number, number>;
    static xAxisGroup: d3.Selection<SVGGElement, unknown, HTMLElement, any>;
    static yAxisGroup: d3.Selection<SVGGElement, unknown, HTMLElement, any>;
    static tooltip: d3.Selection<HTMLDivElement, unknown, HTMLElement, any>;
    ...
    static BarChartSVG(element: BaseType, data: { label: string, value: number }[], type: string, margin: {top: number, right: number, bottom: number, left:number},  options : {
        width: number,
        height: number
    }) {
        SVG.data = data;
